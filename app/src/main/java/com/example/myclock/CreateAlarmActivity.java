...
public class CreateAlarmActivity extends AppCompatActivity implements Document , UiTranslationStateCallback {
    ...
    public void onFinished() {
        Log.d("CreateAlarmActivity", "UiTranslationStateCallback_onFinished()");
    }
}